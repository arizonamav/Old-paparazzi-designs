/* This file has been generated from /home/mav/Desktop/paparazzivn100/conf/settings/tuning_ver_range_new.xml */
/* Please DO NOT EDIT */
...
#define DlSetting(_idx, _value) { \
  switch (_idx) { \
    ...
    case 25: v_ctl_altitude_pgain2 = _value; break;\
    case 26: v_ctl_auto_throttle_cruise_throttle = _value; break;\
    case 27: v_ctl_auto_throttle_cruise_throttle_pgain = _value; break;\
    case 28: v_ctl_auto_throttle_pgain_plus = _value; break;\
    case 29: v_ctl_auto_throttle_pgain_minus = _value; break;\
    case 30: v_ctl_auto_throttle_igain_plus = _value; break;\
    case 31: v_ctl_auto_throttle_igain_minus = _value; break;\
    case 32: v_ctl_auto_throttle_climb_throttle_increment_plus = _value; break;\
    case 33: v_ctl_auto_throttle_climb_throttle_increment_minus = _value; break;\
    case 34: v_ctl_auto_throttle_cruise_throttle_pgain2 = _value; break;\
    case 35: v_ctl_auto_throttle_pgain_plus2 = _value; break;\
    case 36: v_ctl_auto_throttle_pgain_minus2 = _value; break;\
    case 37: v_ctl_auto_throttle_igain_plus2 = _value; break;\
    case 38: v_ctl_auto_throttle_igain_minus2 = _value; break;\
    case 39: v_ctl_auto_throttle_climb_throttle_increment_plus2 = _value; break;\
    case 40: v_ctl_auto_throttle_climb_throttle_increment_minus2 = _value; break;\
  }\
}
#define PeriodicSendDlValue() { \
  ...
  switch (i) { \
    ...
    case 25: var = v_ctl_altitude_pgain2; break;\
    case 26: var = v_ctl_auto_throttle_cruise_throttle; break;\
    case 27: var = v_ctl_auto_throttle_cruise_throttle_pgain; break;\
    case 28: var = v_ctl_auto_throttle_pgain_plus; break;\
    case 29: var = v_ctl_auto_throttle_pgain_minus; break;\
    case 30: var = v_ctl_auto_throttle_igain_plus; break;\
    case 31: var = v_ctl_auto_throttle_igain_minus; break;\
    case 32: var = v_ctl_auto_throttle_climb_throttle_increment_plus; break;\
    case 33: var = v_ctl_auto_throttle_climb_throttle_increment_minus; break;\
    case 34: var = v_ctl_auto_throttle_cruise_throttle_pgain2; break;\
    case 35: var = v_ctl_auto_throttle_pgain_plus2; break;\
    case 36: var = v_ctl_auto_throttle_pgain_minus2; break;\
    case 37: var = v_ctl_auto_throttle_igain_plus2; break;\
    case 38: var = v_ctl_auto_throttle_igain_minus2; break;\
    case 39: var = v_ctl_auto_throttle_climb_throttle_increment_plus2; break;\
    case 40: var = v_ctl_auto_throttle_climb_throttle_increment_minus2; break;\
    default: var = 0.; break;\
  }\
