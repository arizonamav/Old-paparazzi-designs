/* This file has been generated from /home/dragonfly/paparazzi_new/test/paparazzi3/conf/radios/T9cap.xml */
/* Please DO NOT EDIT */
...
#define RADIO_CTL_VRA 5
#define RADIO_GAIN1 RADIO_CTL_VRA
...
\
    tmp_radio = avg_rc_values[RADIO_GAIN1] / RC_AVG_PERIOD -  SYS_TICS_OF_USEC(1520);\
    rc_values[RADIO_GAIN1] = tmp_radio * (tmp_radio >=0 ? (MAX_PPRZ/(float)(SIGNED_SYS_TICS_OF_USEC(2078-1520))) : (MIN_PPRZ/(float)(SIGNED_SYS_TICS_OF_USEC(970-1520))));\
