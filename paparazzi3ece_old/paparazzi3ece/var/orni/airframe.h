/* This file has been generated from /home/dragonfly/paparazzi_new/test/paparazzi3/conf/airframes/orni_mdm.xml */
/* Please DO NOT EDIT */

#ifndef AIRFRAME_H
#define AIRFRAME_H 

#define AIRFRAME_NAME "orni"
#define AC_ID 39
...
\
  command_value = -values[COMMAND_PITCH]+0.45*values[COMMAND_THROTTLE]-values[COMMAND_ROLL];\
...
#define IR_PITCH_NEUTRAL_DEFAULT DegOfRad(0.)
...
#define V_CTL_ALTITUDE_PGAIN 0.5
...
#define V_CTL_AUTO_THROTTLE_PGAIN 0.042
...
#define V_CTL_AUTO_THROTTLE_CRUISE_THROTTLE 0.25
#define V_CTL_AUTO_THROTTLE_NOMINAL_CRUISE_THROTTLE 0.641
#define V_CTL_AUTO_THROTTLE_CLIMB_THROTTLE_INCREMENT 0.127
...
#define V_CTL_THROTTLE_SLEW 0.01
...
#define H_CTL_PITCH_PGAIN 9302
#define H_CTL_PITCH_DGAIN 0.0
#define H_CTL_ELEVATOR_OF_ROLL 1540
#define H_CTL_ROLL_RATE_MODE_DEFAULT 1
#define H_CTL_ROLL_RATE_SETPOINT_PGAIN 6.
#define H_CTL_ROLL_RATE_MAX_SETPOINT 10
#define H_CTL_LO_THROTTLE_ROLL_RATE_PGAIN 3123
#define H_CTL_HI_THROTTLE_ROLL_RATE_PGAIN 3023
...
#define AGR_DESCENT_THROTTLE 0.5
