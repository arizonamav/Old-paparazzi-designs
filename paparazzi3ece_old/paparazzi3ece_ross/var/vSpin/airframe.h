/* This file has been generated from /home/paparazzi/paparazzi3new/conf/airframes/vertigo_arm_spin.xml */
/* Please DO NOT EDIT */

#ifndef AIRFRAME_H
#define AIRFRAME_H 

#define AIRFRAME_NAME "vSpin"
#define AC_ID 66
...
#define SERVO_THROTTLE1 3
#define SERVO_THROTTLE1_NEUTRAL 1200
#define SERVO_THROTTLE1_TRAVEL_UP 0.0833333333333
#define SERVO_THROTTLE1_TRAVEL_DOWN 0.0104166666667
#define SERVO_THROTTLE1_MAX 2000
#define SERVO_THROTTLE1_MIN 1100

#define SERVO_THROTTLE2 5
#define SERVO_THROTTLE2_NEUTRAL 1200
#define SERVO_THROTTLE2_TRAVEL_UP 0.0833333333333
#define SERVO_THROTTLE2_TRAVEL_DOWN 0.0104166666667
#define SERVO_THROTTLE2_MAX 2000
#define SERVO_THROTTLE2_MIN 1100
...
\
  command_value = values[COMMAND_THROTTLE]-(.2*_var_roll);\
  command_value *= command_value>0 ? SERVO_THROTTLE1_TRAVEL_UP : SERVO_THROTTLE1_TRAVEL_DOWN;\
  servo_value = SERVO_THROTTLE1_NEUTRAL + (int16_t)(command_value);\
  actuators[SERVO_THROTTLE1] = ChopServo(servo_value, SERVO_THROTTLE1_MIN, SERVO_THROTTLE1_MAX);\
\
  Actuator(SERVO_THROTTLE1) = SERVOS_TICS_OF_USEC(actuators[SERVO_THROTTLE1]);\
\
  command_value = values[COMMAND_THROTTLE]+(.2*_var_roll);\
  command_value *= command_value>0 ? SERVO_THROTTLE2_TRAVEL_UP : SERVO_THROTTLE2_TRAVEL_DOWN;\
  servo_value = SERVO_THROTTLE2_NEUTRAL + (int16_t)(command_value);\
  actuators[SERVO_THROTTLE2] = ChopServo(servo_value, SERVO_THROTTLE2_MIN, SERVO_THROTTLE2_MAX);\
\
  Actuator(SERVO_THROTTLE2) = SERVOS_TICS_OF_USEC(actuators[SERVO_THROTTLE2]);\
\
...
#define IR_PITCH_NEUTRAL_DEFAULT DegOfRad(-1.99)
...
#define GYRO_ADC_ROLL_NEUTRAL 472
#define GYRO_ADC_PITCH_NEUTRAL 478
#define GYRO_ADC_YAW_NEUTRAL 487
...
#define V_CTL_AUTO_THROTTLE_MAX_CRUISE_THROTTLE 0.60
...
#define H_CTL_LO_THROTTLE_ROLL_RATE_PGAIN 20000.
#define H_CTL_HI_THROTTLE_ROLL_RATE_PGAIN 20000.
#define H_CTL_LO_THROTTLE_PITCH_RATE_PGAIN 20000.
#define H_CTL_HI_THROTTLE_PITCH_RATE_PGAIN 20000.
#define H_CTL_LO_THROTTLE_YAW_RATE_PGAIN 10000.
#define H_CTL_HI_THROTTLE_YAW_RATE_PGAIN 10000.
...
#define AGR_BLEND_START 5
#define AGR_BLEND_END 2
#define AGR_CLIMB_THROTTLE 0.44
#define AGR_CLIMB_PITCH RadOfDeg(15)
#define AGR_DESCENT_THROTTLE 0.36
...
#define DATALINK_DEVICE_TYPE XBEE__
