/*
 * Paparazzi mcu0 $Id: gps_ubx.c,v 1.15 2006/07/20 15:58:06 poine Exp $
 *  
...
void gps_reset(void)
{
//coldstart reset the gps
UbxSend_CFG_RST(0x0001,0x02,0x00); 
}
...
void gps_configure ( void ) {
  UbxSend_CFG_PRT(0x01, 0x00, 0x0000, 0x000080C0, 38400, UBX_PROTO_MASK, UBX_PROTO_MASK, 0x0000, 0x0000);
