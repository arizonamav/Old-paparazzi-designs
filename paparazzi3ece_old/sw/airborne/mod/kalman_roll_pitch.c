...
#define dt 0.015625 //must be exactly same as measurement dt
...
inline void kalman_roll_pitch_init()
{
	float bias=1;
	...
	x_[2]=bias;
	ones3x3(P_last);
	diag3x3(0.000003f, 0.00001f,0.0f,Q);
	diag2x2(0.03f,0.03f,R);
}
inline void kalman_roll_pitch_update()
{
	float det;
	//time update
